...
export class Logger {
  public static getLogger(loggerName = "app"): bunyan {
  ...
  private readonly consoleLogLevel: bunyan.LogLevelString = process.env
    ...
    ? (process.env.VUE_APP_CONSOLE_LOG_LEVEL as bunyan.LogLevelString)
    : "info";
  private readonly enablePostSvrLog: boolean = process.env
    .VUE_APP_ENABLE_POST_SVR_LOG
    ? this.toBoolean(process.env.VUE_APP_ENABLE_POST_SVR_LOG)
    : false;
  private readonly postSvrLogUrl: string = process.env.VUE_APP_POST_SVR_LOG_URL
    ? process.env.VUE_APP_POST_SVR_LOG_URL
    : "/api/v1/log";
  private readonly postSvrLogLevel: bunyan.LogLevelString = process.env
    .VUE_APP_POST_SVR_LOG_LEVEL
    ? (process.env.VUE_APP_POST_SVR_LOG_LEVEL as bunyan.LogLevelString)
    : "warn";
